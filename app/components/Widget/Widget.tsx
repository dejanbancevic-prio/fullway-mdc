...
const Widget = () => {
  return (
    <div className="flex flex-col md:max-w-7xl md:mx-auto w-full">
      <div className="flex flex-col leading-none mb-[0.5rem] mx-[1rem] md:mx-[0rem]">
        <p className="font-[500] italic text-[1.125rem] text-black">
          TIRES JUST FOR YOU
        </p>
      ...
      <div className="relative w-full">
        ...
        <div className="absolute inset-0">
          <Tabs defaultValue="vehicle" className="w-[25rem] text-black ml-1">
