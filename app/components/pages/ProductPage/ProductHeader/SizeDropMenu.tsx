...
const SizeDropMenu = ({  // NOT IN USE, WILL DELETE
  options,
  defaultValue,
  onChange,
}: SizeDropMenuProps) => {
  return (
    <div className="w-full ">
      <Select defaultValue={defaultValue} onValueChange={onChange} >
        <SelectTrigger className="md:w-full rounded-none cursor-pointer [&_svg]:!text-white [&_svg]:rotate-90 [&_svg]:opacity-100 font-[600] text-[1.1rem] ">
          <SelectValue placeholder="Choose tire size" className="h-[5rem] text-3xl"/>
        </SelectTrigger>
