  ...
  return (
    <div className="w-full relative">
      <Image
        ...
        width={1920}
        height={1080}
        className="object-cover h-[100rem] md:h-[80rem] w-full"
      />
      <div className="absolute md:inset-0 -top-[17rem] flex flex-col w-full mt-[17rem] md:mt-0 ">
        <div className="md:max-w-7xl md:mx-auto md:w-full mx-[1rem] md:mt-[6rem] mt-[2rem]">
          ...
          <div className="md:max-w-7xl md:mx-auto mx-[1rem] mt-[5rem] flex flex-col gap-[1.5rem]">
            ...
            <div className="relative h-[24rem] w-full overflow-hidden border border-neutral-700 rounded-md">
              <div className="bg-fullwayRed h-[3.5rem] w-full" />
              <div className="md:flex hidden flex-col gap-[0.8rem] p-[1rem]">
                {Array.from({ length: 9 }).map((_, i) => (
                  ...
                  >
                    {Array.from({ length: 9 }).map((_, j) => (
                      <Skeleton
                        key={j}
                        className="h-[1.25rem] w-full rounded-md"
                      />
                    ))}
                  </div>
                ))}
              </div>
              <div className="md:hidden flex flex-col gap-[0.8rem] p-[1rem]">
                {Array.from({ length: 9 }).map((_, i) => (
                  <div
                    key={i}
                    className="flex justify-between items-center gap-[1rem]"
