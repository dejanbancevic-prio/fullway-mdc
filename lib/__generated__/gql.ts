...
type Documents = {
    ...
    "query BlogPageByTag($keyWord: String!, $currentPage: Int!, $pageSize: Int!, $tag_name: String!) {\n  awBlogPosts(\n    filter: {title: {like: $keyWord}, tag_name: {eq: $tag_name}}\n    currentPage: $currentPage\n    pageSize: $pageSize\n  ) {\n    total_count\n    items {\n      url_key\n      title\n      publish_date\n      authors {\n        firstname\n        lastname\n      }\n      tags {\n        items {\n          id\n          name\n          url_key\n        }\n      }\n    }\n  }\n}": typeof types.BlogPageByTagDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query BlogPageByTag($keyWord: String!, $currentPage: Int!, $pageSize: Int!, $tag_name: String!) {\n  awBlogPosts(\n    filter: {title: {like: $keyWord}, tag_name: {eq: $tag_name}}\n    currentPage: $currentPage\n    pageSize: $pageSize\n  ) {\n    total_count\n    items {\n      url_key\n      title\n      publish_date\n      authors {\n        firstname\n        lastname\n      }\n      tags {\n        items {\n          id\n          name\n          url_key\n        }\n      }\n    }\n  }\n}"): (typeof documents)["query BlogPageByTag($keyWord: String!, $currentPage: Int!, $pageSize: Int!, $tag_name: String!) {\n  awBlogPosts(\n    filter: {title: {like: $keyWord}, tag_name: {eq: $tag_name}}\n    currentPage: $currentPage\n    pageSize: $pageSize\n  ) {\n    total_count\n    items {\n      url_key\n      title\n      publish_date\n      authors {\n        firstname\n        lastname\n      }\n      tags {\n        items {\n          id\n          name\n          url_key\n        }\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
